...
if isempty(trv_trd)
    ...
    if Root == 1 % Include mangrove roots in the model 23/10/2018
        ...
        f            = 0.1; % Constant of roots number increase equation
    ...
    trv_trd(:,4)      = trv_trd(:,12)/num_all; % update the Area Fraction after mortality and colonization
    trv_trd(:,8)      = num_all/S_cell*trv_trd(:,13)/100; % update the density (1/m)
    ...
    % Write TRD
    dlmwrite('veg.trd', trd_txt, '\t'); % write trd file to folder
